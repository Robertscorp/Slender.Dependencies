...
namespace Slender.ServiceRegistrations
{
    ...
    public partial class DependencyCollection
    {
        ...
        public DependencyCollection AddSingleton<TImplementation>()
            => this.AddDependency(typeof(TImplementation), DependencyLifetime.Singleton(), r => r.AddImplementationType<TImplementation>());
        ...
        public DependencyCollection AddSingleton<TImplementation>(TImplementation implementationInstance)
            => this.AddDependency(typeof(TImplementation), DependencyLifetime.Singleton(), r => r.WithImplementationInstance(implementationInstance));
        ...
        public DependencyCollection AddSingleton<TDependency, TImplementation>() where TImplementation : TDependency
            => this.AddDependency(typeof(TDependency), DependencyLifetime.Singleton(), r => r.AddImplementationType<TImplementation>());
        ...
        public DependencyCollection AddSingleton<TDependency>(object implementationInstance)
            => this.AddDependency(typeof(TDependency), DependencyLifetime.Singleton(), r => r.WithImplementationInstance(implementationInstance));
